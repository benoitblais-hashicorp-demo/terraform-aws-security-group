...
### <a name="input_auto_groups"></a> [auto\_groups](#input\_auto\_groups)

Description: Map of groups of security group rules to use to generate modules (see update\_groups.sh)
...
### <a name="input_computed_ingress_with_prefix_list_ids"></a> [computed\_ingress\_with\_prefix\_list\_ids](#input\_computed\_ingress\_with\_prefix\_list\_ids)

Description: List of computed ingress rules to create where 'prefix\_list\_ids' is used
