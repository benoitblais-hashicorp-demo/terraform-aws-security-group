...
Thank you for your interest in contributing! This repository uses **Terraform** to provision AWS Security Groups and their associated rules to control traffic. Please review these guidelines before contributing.
...
* **Naming Conventions:** Use `snake_case` for all resource and variable names. Avoid including the resource type in the name (i.e., `aws_security_group.main`, not `aws_security_group.sg_main`).
