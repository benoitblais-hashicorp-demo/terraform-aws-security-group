...
This project is a Terraform module designed to provision and manage Amazon Web Services (AWS) Security Groups. It creates and configures security groups and their associated ingress and egress rules to control inbound and outbound traffic for AWS resources, ensuring a secure network perimeter.
...
- Example: `resource "aws_security_group" "main"` not `resource "aws_security_group" "sg_main"`.
